...
This file documents the project-specific agent skills available in this repository.

## Skills

*   **[run-task-all](./skills/run_task_all.md)**: Runs repository-wide validation, tests, and link checker (`task all`) and automatically fixes any issues.
*   **[check-and-fix-workflows](./skills/check_and_fix_workflows.md)**: Check recent GitHub Actions workflow runs for failures, view logs, and diagnose/repair workflow issues.
